...
function HomePage() {
  return (
    <div className="max-w-4xl mx-auto bg-black text-white p-8 rounded-lg shadow-lg">  {/* Added styling for homepage content*/}
          ...
          <div className="grid gap-4">
            {[
              ...
              <Link
                key={phase.href}
                href={phase.href}
                className="p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition-colors bg-gray-700"
              >
